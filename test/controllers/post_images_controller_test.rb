...
class PostImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_image" do
    assert_difference('PostImage.count') do
      post post_images_url, params: { post_image: { image: @post_image.image, post_id: @post_image.post_id } }
    end
  ...
  test "should update post_image" do
    patch post_image_url(@post_image), params: { post_image: { image: @post_image.image, post_id: @post_image.post_id } }
